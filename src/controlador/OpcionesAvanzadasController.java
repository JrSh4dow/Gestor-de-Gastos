...
public class OpcionesAvanzadasController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        FechaElegida.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                ColumnaTotalMesElegido.setCellValueFactory(cellData -> new SimpleDoubleProperty(Totales(cellData.getValue(), elegida)).asObject());
        ...
        ColumnaTotalMesActual.setCellValueFactory(cellData -> new SimpleDoubleProperty(Totales(cellData.getValue(), actual)).asObject());
    ...
    private void actualizarGrafica() {
        ...
        seriesElegido.setName(elegida.getMonth().getDisplayName(TextStyle.FULL, Locale.getDefault())); // Nombre del mes elegido
